...
const int ledPin = D4; // This code uses the built-in led for visual feedback that the button has been pressed
const int buttonPin = D0; // Connect your button to pin #13

// WiFi
// Make sure to update this for your own WiFi network!
const char* ssid = "AKASH VAIO";
const char* wifi_password = "9645960937";

// MQTT
// Make sure to update this for your own MQTT Broker!
const char* mqtt_server = "192.168.137.75";
