...
#define MpwmBL 9   //BOTTOM LEFT
#define MpwmBR 10   //BOTTOM RIGHT

#define MdirectionR1 5
#define MdirectionR2 6
#define MdirectionL1 7
#define MdirectionL2 8

// proportional gain
float Kp = 100; //org 7.5
// deferential gain
float Kd = 0.5; //org 0.5
// integral gain
float Ki = 12.5; //12.5
String dir = "";
float error = 0;
...
#define LED_PIN 13 // 
int MPUOffsets[6] = {-2498,-660,475,91,-67,44}; //GY-521
//int MPUOffsets[6] = { -208 , -1523, 1631,  77,  -20, 40}; //GY-521
//int MPUOffsets[6] = {155 ,-1523 ,1652  ,74  ,-23  ,41 };  //GY-88
